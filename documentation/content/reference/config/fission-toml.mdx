...
| --- | --- | --- | --- | --- |
| `targets` | array of strings | Yes for app/package commands | `android`, `ios`, `linux`, `macos`, `site`, `web`, `windows` | Declares which generated hosts belong to the project. Commands use it to reject packaging/running a target that has not been added. |
