---
title: Targets
description: The reference contract for generated target hosts, checked-in smoke paths, and practical expectations across desktop, web, Android, iOS, static site, and server-rendered site output.
---
...
Use the site target when the output must be crawlable static HTML for documentation, marketing, reference, or blog pages.

Use the server target when the page needs request-time data, sessions, signed actions, cache revalidation, progressive workers, or focused browser islands.
