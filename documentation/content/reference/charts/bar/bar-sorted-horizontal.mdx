...
sidebar_label: Sorted horizontal bars
description: Fission Charts reference for Sorted horizontal bars.
---

# Sorted horizontal bars

![Sorted horizontal bars screenshot](/img/charts/bar-sorted-horizontal.png)

Horizontal ranking sorted largest to smallest. Use it for top-N views. The screenshot is captured from the native Fission chart gallery.

## What the chart is for

Sorted horizontal bars is part of the **Bar** chart family and is intended for `BarSeries with category y-axis`. Use it when the visual form makes the user's question faster to answer than a table or a simpler chart would.
...
pub struct SortedHorizontalBarsChart;

impl From<SortedHorizontalBarsChart> for Widget {
    fn from(_: SortedHorizontalBarsChart) -> Widget {
        Chart::new()
            .title("Orders")
            .x_axis(Axis::category(vec!["Q1", "Q2", "Q3", "Q4"]))
            .y_axis(Axis::value())
