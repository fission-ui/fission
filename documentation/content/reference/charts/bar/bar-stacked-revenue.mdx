...
Stacked revenue bars is part of the **Bar** chart family and is intended for `Multiple BarSeries sharing a stack key`. Use it when the visual form makes the user's question faster to answer than a table or a simpler chart would.
