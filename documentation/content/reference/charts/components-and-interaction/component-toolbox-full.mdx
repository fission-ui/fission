---
title: Toolbox full
sidebar_label: Toolbox full
description: Fission Charts reference for Toolbox full.
---

# Toolbox full

![Toolbox full screenshot](/img/charts/component-toolbox-full.png)

Full toolbox action set. Use it when a chart supports several operations. The screenshot is captured from the native Fission chart gallery.

## What the chart is for

Toolbox full is part of the **Components and interaction** chart family and is intended for `ChartInteraction toolbox actions`. Use it when the visual form makes the user's question faster to answer than a table or a simpler chart would.
...
pub struct ToolboxFullChart;

impl From<ToolboxFullChart> for Widget {
    fn from(_: ToolboxFullChart) -> Widget {
        Chart::new()
            .title("Trend")
            .x_axis(Axis::category(vec!["Mon", "Tue", "Wed", "Thu", "Fri"]))
            .y_axis(Axis::value())
