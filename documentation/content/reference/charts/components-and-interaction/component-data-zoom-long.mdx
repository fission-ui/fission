...
sidebar_label: Data zoom long
description: Fission Charts reference for Data zoom long.
---

# Data zoom long

![Data zoom long screenshot](/img/charts/component-data-zoom-long.png)

Wide data zoom window over ordered data. Use it for dashboards with focus ranges. The screenshot is captured from the native Fission chart gallery.

## What the chart is for

Data zoom long is part of the **Components and interaction** chart family and is intended for `DataZoom plus LineSeries`. Use it when the visual form makes the user's question faster to answer than a table or a simpler chart would.
...
pub struct DataZoomLongChart;

impl From<DataZoomLongChart> for Widget {
    fn from(_: DataZoomLongChart) -> Widget {
        Chart::new()
            .title("Trend")
            .x_axis(Axis::category(vec!["Mon", "Tue", "Wed", "Thu", "Fri"]))
            .y_axis(Axis::value())
