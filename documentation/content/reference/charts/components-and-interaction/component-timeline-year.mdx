...
![Timeline years screenshot](/img/charts/component-timeline-year.png)

Timeline component selecting a year. Use it for step-based snapshots. The screenshot is captured from the native Fission chart gallery.

## What the chart is for

Timeline years is part of the **Components and interaction** chart family and is intended for `ChartTimeline plus series`. Use it when the visual form makes the user's question faster to answer than a table or a simpler chart would.
