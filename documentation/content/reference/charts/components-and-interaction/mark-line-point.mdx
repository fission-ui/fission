...
sidebar_label: Mark line and point
description: Fission Charts reference for Mark line and point.
---

# Mark line and point

![Mark line and point screenshot](/img/charts/mark-line-point.png)
...
Mark line and point is part of the **Components and interaction** chart family and is intended for `MarkArea, MarkLine, and MarkPoint records attached to a chart`. Use it when the visual form makes the user's question faster to answer than a table or a simpler chart would.
