...
Brush selection is part of the **Components and interaction** chart family and is intended for `ChartBrush configuration plus hit-testable series data`. Use it when the visual form makes the user's question faster to answer than a table or a simpler chart would.
...
pub struct BrushSelectionChart;

impl From<BrushSelectionChart> for Widget {
    fn from(_: BrushSelectionChart) -> Widget {
        Chart::new()
            .title("Brush selection")
            .width(720.0)
            .height(480.0)
