...
![Graphic band screenshot](/img/charts/component-graphic-band.png)

Graphic highlight and label overlay. Use it for release windows and custom callouts. The screenshot is captured from the native Fission chart gallery.

## What the chart is for

Graphic band is part of the **Components and interaction** chart family and is intended for `ChartGraphic plus LineSeries`. Use it when the visual form makes the user's question faster to answer than a table or a simpler chart would.
