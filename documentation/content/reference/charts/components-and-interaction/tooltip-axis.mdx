...
Axis tooltip is part of the **Components and interaction** chart family and is intended for `Tooltip::axis_trigger plus series data under shared axes`. Use it when the visual form makes the user's question faster to answer than a table or a simpler chart would.
