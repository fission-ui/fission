...
Data zoom is part of the **Components and interaction** chart family and is intended for `DataZoom start and end percentages plus ordered series data`. Use it when the visual form makes the user's question faster to answer than a table or a simpler chart would.
