...
Toolbox actions is part of the **Components and interaction** chart family and is intended for `ChartInteraction toolbox action list`. Use it when the visual form makes the user's question faster to answer than a table or a simpler chart would.
...
pub struct ToolboxActionsChart;

impl From<ToolboxActionsChart> for Widget {
    fn from(_: ToolboxActionsChart) -> Widget {
        Chart::new()
            .title("Toolbox actions")
            .width(720.0)
            .height(480.0)
