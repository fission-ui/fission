...
Support load heatmap is part of the **Heatmap** chart family and is intended for `Two-dimensional grid cells with values`. Use it when the visual form makes the user's question faster to answer than a table or a simpler chart would.
