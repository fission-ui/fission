...
3D mesh field is part of the **3D and GL** chart family and is intended for `Mesh surface primitive`. Use it when the visual form makes the user's question faster to answer than a table or a simpler chart would.
...
pub struct Fission3DMeshFieldChart;

impl From<Fission3DMeshFieldChart> for Widget {
    fn from(_: Fission3DMeshFieldChart) -> Widget {
        Chart::new()
            .title("3D mesh field")
