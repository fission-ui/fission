...
sidebar_label: Terrain surface
description: Fission Charts reference for Terrain surface.
---

# Terrain surface

![Terrain surface screenshot](/img/charts/terrain-surface.png)
...
Terrain surface is part of the **3D and GL** chart family and is intended for `Grid-generated mesh vertices and triangle indices`. Use it when spatial data is genuinely easier to understand in a 3D viewport.
...
pub struct TerrainSurfaceChart;

impl From<TerrainSurfaceChart> for Widget {
    fn from(_: TerrainSurfaceChart) -> Widget {
        Chart::new()
            .title("Terrain surface")
