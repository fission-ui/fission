...
3D globe coverage is part of the **3D and GL** chart family and is intended for `Globe primitive with highlighted locations`. Use it when the visual form makes the user's question faster to answer than a table or a simpler chart would.
...
pub struct Fission3DGlobeCoverageChart;

impl From<Fission3DGlobeCoverageChart> for Widget {
    fn from(_: Fission3DGlobeCoverageChart) -> Widget {
        Chart::new()
            .title("3D globe coverage")
