...
3D bar is part of the **3D and GL** chart family and is intended for `A grid of values lowered into Scene3D mesh cuboids`. Use it when the visual form makes the user's question faster to answer than a table or a simpler chart would.
...
pub struct Fission3DBarChart;

impl From<Fission3DBarChart> for Widget {
    fn from(_: Fission3DBarChart) -> Widget {
        Chart::new()
            .title("3D bar")
