...
Sparse 3D point cloud is part of the **3D and GL** chart family and is intended for `Sparse spatial points`. Use it when the visual form makes the user's question faster to answer than a table or a simpler chart would.
...
pub struct Sparse3DPointCloudChart;

impl From<Sparse3DPointCloudChart> for Widget {
    fn from(_: Sparse3DPointCloudChart) -> Widget {
        Chart::new()
            .title("Sparse 3D point cloud")
