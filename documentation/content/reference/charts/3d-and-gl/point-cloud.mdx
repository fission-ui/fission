...
Point cloud is part of the **3D and GL** chart family and is intended for `A collection of x, y, z positions with point radii`. Use it when spatial data is genuinely easier to understand in a 3D viewport.
...
pub struct PointCloudChart;

impl From<PointCloudChart> for Widget {
    fn from(_: PointCloudChart) -> Widget {
        Chart::new()
            .title("Point cloud")
