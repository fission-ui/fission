---
title: Globe markers
sidebar_label: Globe markers
description: Fission Charts reference for Globe markers.
---

# Globe markers

![Globe markers screenshot](/img/charts/globe-markers.png)

Globe primitive with marker locations. Use it for global context. The screenshot is captured from the native Fission chart gallery.

## What the chart is for

Globe markers is part of the **3D and GL** chart family and is intended for `Scene3D spheres`. Use it when the visual form makes the user's question faster to answer than a table or a simpler chart would.
...
pub struct GlobeMarkersChart;

impl From<GlobeMarkersChart> for Widget {
    fn from(_: GlobeMarkersChart) -> Widget {
        Chart::new()
            .title("Globe markers")
