...
![3D grid bars screenshot](/img/charts/bar3d-grid.png)

3D bars over a grid. Use it when depth and grouping are part of the data. The screenshot is captured from the native Fission chart gallery.

## What the chart is for

3D grid bars is part of the **3D and GL** chart family and is intended for `Scene3D mesh cuboids`. Use it when the visual form makes the user's question faster to answer than a table or a simpler chart would.
