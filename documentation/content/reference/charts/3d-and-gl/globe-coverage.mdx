...
sidebar_label: Globe coverage
description: Fission Charts reference for Globe coverage.
---

# Globe coverage

![Globe coverage screenshot](/img/charts/globe-coverage.png)

Globe variant for coverage displays. Use it for global product views. The screenshot is captured from the native Fission chart gallery.

## What the chart is for

Globe coverage is part of the **3D and GL** chart family and is intended for `Scene3D spheres`. Use it when the visual form makes the user's question faster to answer than a table or a simpler chart would.
...
pub struct GlobeCoverageChart;

impl From<GlobeCoverageChart> for Widget {
    fn from(_: GlobeCoverageChart) -> Widget {
        Chart::new()
            .title("Globe coverage")
