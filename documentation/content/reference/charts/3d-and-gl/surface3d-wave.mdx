...
![3D wave surface screenshot](/img/charts/surface3d-wave.png)

Smooth mesh surface. Use it for sampled surfaces. The screenshot is captured from the native Fission chart gallery.

## What the chart is for

3D wave surface is part of the **3D and GL** chart family and is intended for `Scene3D mesh vertices and indices`. Use it when the visual form makes the user's question faster to answer than a table or a simpler chart would.
