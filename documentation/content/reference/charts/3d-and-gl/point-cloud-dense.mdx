...
Dense point cloud is part of the **3D and GL** chart family and is intended for `Scene3D spheres`. Use it when the visual form makes the user's question faster to answer than a table or a simpler chart would.
...
pub struct DensePointCloudChart;

impl From<DensePointCloudChart> for Widget {
    fn from(_: DensePointCloudChart) -> Widget {
        Chart::new()
            .title("Dense point cloud")
