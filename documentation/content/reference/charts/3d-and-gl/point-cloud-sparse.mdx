...
sidebar_label: Sparse point cloud
description: Fission Charts reference for Sparse point cloud.
---

# Sparse point cloud

![Sparse point cloud screenshot](/img/charts/point-cloud-sparse.png)

Sparse point cloud in 3D space. Use it for sampled spatial observations. The screenshot is captured from the native Fission chart gallery.

## What the chart is for

Sparse point cloud is part of the **3D and GL** chart family and is intended for `Scene3D spheres`. Use it when the visual form makes the user's question faster to answer than a table or a simpler chart would.
...
pub struct SparsePointCloudChart;

impl From<SparsePointCloudChart> for Widget {
    fn from(_: SparsePointCloudChart) -> Widget {
        Chart::new()
            .title("Sparse point cloud")
