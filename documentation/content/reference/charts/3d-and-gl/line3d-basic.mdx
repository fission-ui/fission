...
3D line is part of the **3D and GL** chart family and is intended for `Ordered 3D positions lowered into Scene3D primitives`. Use it when spatial data is genuinely easier to understand in a 3D viewport.
...
pub struct Fission3DLineChart;

impl From<Fission3DLineChart> for Widget {
    fn from(_: Fission3DLineChart) -> Widget {
        Chart::new()
            .title("3D line")
