...
Globe is part of the **3D and GL** chart family and is intended for `Scene3D sphere primitives plus marker primitives`. Use it when spatial data is genuinely easier to understand in a 3D viewport.
