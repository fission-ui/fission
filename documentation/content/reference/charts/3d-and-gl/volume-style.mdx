...
sidebar_label: Volume-style point field
description: Fission Charts reference for Volume-style point field.
---

# Volume-style point field

![Volume-style point field screenshot](/img/charts/volume-style.png)

Dense point field suggesting volume data. Use it as the current native path toward volume-style visualization. The screenshot is captured from the native Fission chart gallery.

## What the chart is for

Volume-style point field is part of the **3D and GL** chart family and is intended for `Scene3D spheres`. Use it when the visual form makes the user's question faster to answer than a table or a simpler chart would.
...
pub struct VolumeStylePointFieldChart;

impl From<VolumeStylePointFieldChart> for Widget {
    fn from(_: VolumeStylePointFieldChart) -> Widget {
        Chart::new()
            .title("Volume-style point field")
