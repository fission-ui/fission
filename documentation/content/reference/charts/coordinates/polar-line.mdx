...
Polar line is part of the **Coordinates** chart family and is intended for `Vec<(angle_degrees, radius)>`. Use it when the visual form makes the user's question faster to answer than a table or a simpler chart would.
