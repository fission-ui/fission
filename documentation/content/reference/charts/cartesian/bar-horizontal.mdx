...
description: Fission Charts reference for Horizontal bar.
---

# Horizontal bar

![Horizontal bar screenshot](/img/charts/bar-horizontal.png)

A category comparison with value length running left to right. Use it when category labels are long or ranking order is more important than time order. The screenshot is captured from the native Fission chart gallery.

## What the chart is for

Horizontal bar is part of the **Cartesian** chart family and is intended for `BarSeries values with a category y-axis and value x-axis`. Use it when the visual form makes the user's question faster to answer than a table or a simpler chart would.
