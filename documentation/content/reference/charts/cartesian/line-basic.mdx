---
title: Basic line
sidebar_label: Basic line
description: Fission Charts reference for Basic line.
---

# Basic line

![Basic line screenshot](/img/charts/line-basic.png)

A single ordered numeric series with a clear trend line. Use it when the shape of change matters more than individual bars. The screenshot is captured from the native Fission chart gallery.

## What the chart is for

Basic line is part of the **Cartesian** chart family and is intended for `Vec<f32> on a category, value, or time axis`. Use it when the visual form makes the user's question faster to answer than a table or a simpler chart would.
...
pub struct BasicLineChart;

impl From<BasicLineChart> for Widget {
    fn from(_: BasicLineChart) -> Widget {
        Chart::new()
            .title("Trend")
            .x_axis(Axis::category(vec!["Mon", "Tue", "Wed", "Thu", "Fri", "Sat", "Sun"]))
            .y_axis(Axis::value())
