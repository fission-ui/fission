...
Bar with background is part of the **Cartesian** chart family and is intended for `BarSeries values plus background and border-radius styling`. Use it when the visual form makes the user's question faster to answer than a table or a simpler chart would.
