...
Positive and negative bar is part of the **Cartesian** chart family and is intended for `BarSeries values that may be positive or negative`. Use it when the visual form makes the user's question faster to answer than a table or a simpler chart would.
