---
title: Large line
sidebar_label: Large line
description: Fission Charts reference for Large line.
---

# Large line

![Large line screenshot](/img/charts/line-large.png)
...
Large line is part of the **Cartesian** chart family and is intended for `A longer Vec<f32> aligned to ordered category samples`. Use it when the visual form makes the user's question faster to answer than a table or a simpler chart would.
...
pub struct LargeLineChart;

impl From<LargeLineChart> for Widget {
    fn from(_: LargeLineChart) -> Widget {
        Chart::new()
            .title("Trend")
            .x_axis(Axis::category(vec!["Mon", "Tue", "Wed", "Thu", "Fri", "Sat", "Sun"]))
            .y_axis(Axis::value())
