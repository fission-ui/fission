...
Word cloud is part of the **Data pipeline and interaction** chart family and is intended for `Label/value pairs where the label is the word and the value controls size`. Use it when the visual form makes the user's question faster to answer than a table or a simpler chart would.
...
impl From<WordCloudChart> for Widget {
    fn from(_: WordCloudChart) -> Widget {
        Chart::new()
            .title("Word cloud")
            .width(720.0)
            .height(480.0)
