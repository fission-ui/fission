---
title: Org tree
sidebar_label: Org tree
description: Fission Charts reference for Org tree.
---

# Org tree

![Org tree screenshot](/img/charts/tree-org.png)

Parent-child hierarchy as a tidy tree. Use it for organization and ownership charts. The screenshot is captured from the native Fission chart gallery.

## What the chart is for

Org tree is part of the **Hierarchy and flow** chart family and is intended for `Nested nodes`. Use it when the visual form makes the user's question faster to answer than a table or a simpler chart would.
...
pub struct OrgTreeChart;

impl From<OrgTreeChart> for Widget {
    fn from(_: OrgTreeChart) -> Widget {
        Chart::new()
            .title("Trend")
            .x_axis(Axis::category(vec!["Mon", "Tue", "Wed", "Thu", "Fri"]))
            .y_axis(Axis::value())
