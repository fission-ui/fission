...
![Dependency graph screenshot](/img/charts/graph-dependencies.png)

Network nodes and edges. Use it for dependency and topology diagrams. The screenshot is captured from the native Fission chart gallery.

## What the chart is for

Dependency graph is part of the **Hierarchy and flow** chart family and is intended for `Graph nodes plus edges`. Use it when the visual form makes the user's question faster to answer than a table or a simpler chart would.
