---
title: Energy sankey
sidebar_label: Energy sankey
description: Fission Charts reference for Energy sankey.
---

# Energy sankey

![Energy sankey screenshot](/img/charts/sankey-energy.png)

Flow bands between stages. Use it for material, energy, or revenue flow. The screenshot is captured from the native Fission chart gallery.

## What the chart is for

Energy sankey is part of the **Hierarchy and flow** chart family and is intended for `Vertex list plus edges`. Use it when the visual form makes the user's question faster to answer than a table or a simpler chart would.
...
pub struct EnergySankeyChart;

impl From<EnergySankeyChart> for Widget {
    fn from(_: EnergySankeyChart) -> Widget {
        Chart::new()
            .title("Trend")
            .x_axis(Axis::category(vec!["Mon", "Tue", "Wed", "Thu", "Fri"]))
            .y_axis(Axis::value())
