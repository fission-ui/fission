...
sidebar_label: Demand theme river
description: Fission Charts reference for Demand theme river.
---

# Demand theme river

![Demand theme river screenshot](/img/charts/theme-river-demand.png)

Theme river chart for demand sources. Use it for campaign or demand mix. The screenshot is captured from the native Fission chart gallery.

## What the chart is for

Demand theme river is part of the **Hierarchy and flow** chart family and is intended for `Time/value/category tuples`. Use it when the visual form makes the user's question faster to answer than a table or a simpler chart would.
...
pub struct DemandThemeRiverChart;

impl From<DemandThemeRiverChart> for Widget {
    fn from(_: DemandThemeRiverChart) -> Widget {
        Chart::new()
            .title("Trend")
            .x_axis(Axis::category(vec!["Mon", "Tue", "Wed", "Thu", "Fri"]))
            .y_axis(Axis::value())
