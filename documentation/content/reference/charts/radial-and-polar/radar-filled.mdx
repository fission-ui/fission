...
Filled radar is part of the **Radial and polar** chart family and is intended for `Metric profiles plus fill style`. Use it when the visual form makes the user's question faster to answer than a table or a simpler chart would.
...
pub struct FilledRadarChart;

impl From<FilledRadarChart> for Widget {
    fn from(_: FilledRadarChart) -> Widget {
        Chart::new()
            .title("Filled radar")
            .width(720.0)
            .height(480.0)
