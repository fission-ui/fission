...
Radar is part of the **Radial and polar** chart family and is intended for `Vec<Vec<f32>> where each row is one profile`. Use it when the visual form makes the user's question faster to answer than a table or a simpler chart would.
