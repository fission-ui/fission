...
Donut is part of the **Radial and polar** chart family and is intended for `Label/value pairs plus inner radius`. Use it when the visual form makes the user's question faster to answer than a table or a simpler chart would.
...
impl From<DonutChart> for Widget {
    fn from(_: DonutChart) -> Widget {
        Chart::new()
            .title("Share")
            .series(vec![PieSeries::new("Share")
                .data(vec![("Search", 1048.0), ("Direct", 735.0), ("Email", 580.0), ("Ads", 484.0)])
