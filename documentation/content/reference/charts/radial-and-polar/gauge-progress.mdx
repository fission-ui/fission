...
Progress gauge is part of the **Radial and polar** chart family and is intended for `One or more bounded values`. Use it when the visual form makes the user's question faster to answer than a table or a simpler chart would.
...
pub struct ProgressGaugeChart;

impl From<ProgressGaugeChart> for Widget {
    fn from(_: ProgressGaugeChart) -> Widget {
        Chart::new()
            .title("Progress gauge")
            .width(720.0)
            .height(480.0)
