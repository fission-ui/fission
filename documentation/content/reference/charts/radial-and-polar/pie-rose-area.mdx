---
title: Rose by area
sidebar_label: Rose by area
description: Fission Charts reference for Rose by area.
---

# Rose by area

![Rose by area screenshot](/img/charts/pie-rose-area.png)
...
Rose by area is part of the **Radial and polar** chart family and is intended for `Label/value pairs plus area rose mode`. Use it when the visual form makes the user's question faster to answer than a table or a simpler chart would.
...
pub struct RoseByAreaChart;

impl From<RoseByAreaChart> for Widget {
    fn from(_: RoseByAreaChart) -> Widget {
        Chart::new()
            .title("Share")
            .series(vec![PieSeries::new("Share")
                .data(vec![("Search", 1048.0), ("Direct", 735.0), ("Email", 580.0), ("Ads", 484.0)])
