...
Plan share pie is part of the **Radial** chart family and is intended for `Label/value pairs for a small whole`. Use it when the visual form makes the user's question faster to answer than a table or a simpler chart would.
...
pub struct PlanSharePieChart;

impl From<PlanSharePieChart> for Widget {
    fn from(_: PlanSharePieChart) -> Widget {
        Chart::new()
            .title("Share")
            .legend(Legend::top_right())
            .series(vec![PieSeries::new("Share")
