...
Device donut is part of the **Radial** chart family and is intended for `Label/value pairs with an open center`. Use it when the visual form makes the user's question faster to answer than a table or a simpler chart would.
...
pub struct DeviceDonutChart;

impl From<DeviceDonutChart> for Widget {
    fn from(_: DeviceDonutChart) -> Widget {
        Chart::new()
            .title("Share")
            .legend(Legend::top_right())
            .series(vec![PieSeries::new("Share")
