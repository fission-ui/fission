...
Source mix pie is part of the **Radial** chart family and is intended for `Traffic or source categories with values`. Use it when the visual form makes the user's question faster to answer than a table or a simpler chart would.
...
pub struct SourceMixPieChart;

impl From<SourceMixPieChart> for Widget {
    fn from(_: SourceMixPieChart) -> Widget {
        Chart::new()
            .title("Share")
            .legend(Legend::top_right())
            .series(vec![PieSeries::new("Share")
