...
Team balance radar is part of the **Radial** chart family and is intended for `Team capability vectors`. Use it when the visual form makes the user's question faster to answer than a table or a simpler chart would.
...
pub struct TeamBalanceRadarChart;

impl From<TeamBalanceRadarChart> for Widget {
    fn from(_: TeamBalanceRadarChart) -> Widget {
        Chart::new()
            .title("Share")
            .legend(Legend::top_right())
            .series(vec![PieSeries::new("Share")
