...
sidebar_label: Hourly load polar bars
description: Fission Charts reference for Hourly load polar bars.
---

# Hourly load polar bars

![Hourly load polar bars screenshot](/img/charts/polar-hourly-load.png)
