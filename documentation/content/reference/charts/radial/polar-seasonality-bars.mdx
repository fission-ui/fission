...
Seasonality polar bars is part of the **Radial** chart family and is intended for `Cyclic label/value pairs`. Use it when the visual form makes the user's question faster to answer than a table or a simpler chart would.
...
pub struct SeasonalityPolarBarsChart;

impl From<SeasonalityPolarBarsChart> for Widget {
    fn from(_: SeasonalityPolarBarsChart) -> Widget {
        Chart::new()
            .title("Share")
            .legend(Legend::top_right())
            .series(vec![PieSeries::new("Share")
