...
Market rose is part of the **Radial** chart family and is intended for `Label/value pairs with radius emphasis`. Use it when the visual form makes the user's question faster to answer than a table or a simpler chart would.
