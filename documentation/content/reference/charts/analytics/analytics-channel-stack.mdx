...
Channel stack is part of the **Analytics** chart family and is intended for `Channel values stacked by category`. Use it when the visual form makes the user's question faster to answer than a table or a simpler chart would.
