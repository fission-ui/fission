...
description: Fission Charts reference for Treemap.
---

# Treemap

![Treemap screenshot](/img/charts/treemap-basic.png)

Hierarchical values packed into rectangles. Use it for storage, budgets, or part-to-whole hierarchy. The screenshot is captured from the native Fission chart gallery.

## What the chart is for

Treemap is part of the **Relationships and hierarchy** chart family and is intended for `Nested nodes with values`. Use it when the visual form makes the user's question faster to answer than a table or a simpler chart would.
...
impl From<TreemapChart> for Widget {
    fn from(_: TreemapChart) -> Widget {
        Chart::new()
            .title("Treemap")
            .width(720.0)
            .height(480.0)
