...
Sankey is part of the **Relationships and hierarchy** chart family and is intended for `Vertex list plus weighted edges`. Use it when the visual form makes the user's question faster to answer than a table or a simpler chart would.
