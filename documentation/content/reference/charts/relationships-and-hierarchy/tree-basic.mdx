...
title: Tree
sidebar_label: Tree
description: Fission Charts reference for Tree.
---

# Tree

![Tree screenshot](/img/charts/tree-basic.png)

A rooted hierarchy drawn with parent-child links. Use it for navigation structures, ownership trees, and dependency drilldown. The screenshot is captured from the native Fission chart gallery.

## What the chart is for

Tree is part of the **Relationships and hierarchy** chart family and is intended for `Nested nodes with optional values`. Use it when the visual form makes the user's question faster to answer than a table or a simpler chart would.
...
impl From<TreeChart> for Widget {
    fn from(_: TreeChart) -> Widget {
        Chart::new()
            .title("Tree")
            .width(720.0)
            .height(480.0)
