---
title: Radial tree
sidebar_label: Radial tree
description: Fission Charts reference for Radial tree.
---

# Radial tree

![Radial tree screenshot](/img/charts/tree-radial.png)

A tree layout arranged around a circle. Use it when the hierarchy is shallow and symmetry matters more than linear reading. The screenshot is captured from the native Fission chart gallery.

## What the chart is for

Radial tree is part of the **Relationships and hierarchy** chart family and is intended for `Nested nodes with optional values`. Use it when the visual form makes the user's question faster to answer than a table or a simpler chart would.
...
pub struct RadialTreeChart;

impl From<RadialTreeChart> for Widget {
    fn from(_: RadialTreeChart) -> Widget {
        Chart::new()
            .title("Radial tree")
            .width(720.0)
            .height(480.0)
