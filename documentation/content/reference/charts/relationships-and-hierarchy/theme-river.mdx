---
title: Theme river
sidebar_label: Theme river
description: Fission Charts reference for Theme river.
---

# Theme river

![Theme river screenshot](/img/charts/theme-river.png)

Stacked flowing bands over time. Use it when composition changes continuously over time. The screenshot is captured from the native Fission chart gallery.

## What the chart is for

Theme river is part of the **Relationships and hierarchy** chart family and is intended for `Time, value, and category tuples`. Use it when the visual form makes the user's question faster to answer than a table or a simpler chart would.
...
impl From<ThemeRiverChart> for Widget {
    fn from(_: ThemeRiverChart) -> Widget {
        Chart::new()
            .title("Theme river")
            .width(720.0)
            .height(480.0)
