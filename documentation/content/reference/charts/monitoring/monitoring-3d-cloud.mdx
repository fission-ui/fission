...
Monitoring 3D cloud is part of the **Monitoring** chart family and is intended for `3D point cloud of operational samples`. Use it when the visual form makes the user's question faster to answer than a table or a simpler chart would.
...
pub struct Monitoring3DCloudChart;

impl From<Monitoring3DCloudChart> for Widget {
    fn from(_: Monitoring3DCloudChart) -> Widget {
        Chart::new()
            .title("Monitoring 3D cloud")
