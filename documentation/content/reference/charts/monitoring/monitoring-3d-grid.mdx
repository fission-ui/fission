...
Monitoring 3D grid is part of the **Monitoring** chart family and is intended for `3D grid bars for operational values`. Use it when the visual form makes the user's question faster to answer than a table or a simpler chart would.
