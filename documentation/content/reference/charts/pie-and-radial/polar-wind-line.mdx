...
sidebar_label: Wind polar line
description: Fission Charts reference for Wind polar line.
---

# Wind polar line

![Wind polar line screenshot](/img/charts/polar-wind-line.png)

Directional values on a polar line. Use it for direction and magnitude data. The screenshot is captured from the native Fission chart gallery.

## What the chart is for

Wind polar line is part of the **Pie and radial** chart family and is intended for `Angle/radius samples`. Use it when the visual form makes the user's question faster to answer than a table or a simpler chart would.
...
pub struct WindPolarLineChart;

impl From<WindPolarLineChart> for Widget {
    fn from(_: WindPolarLineChart) -> Widget {
        Chart::new()
            .title("Share")
            .legend(Legend::top_right())
            .series(vec![PieSeries::new("Share")
