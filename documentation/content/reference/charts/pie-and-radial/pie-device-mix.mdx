...
![Device mix donut screenshot](/img/charts/pie-device-mix.png)

Donut chart for device or channel mix. Use it when the total belongs in the center of the chart. The screenshot is captured from the native Fission chart gallery.

## What the chart is for

Device mix donut is part of the **Pie and radial** chart family and is intended for `Label/value pairs plus inner radius`. Use it when the visual form makes the user's question faster to answer than a table or a simpler chart would.
