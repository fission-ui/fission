...
Geo lines is part of the **Geographic and route** chart family and is intended for `GeoJSON regions plus route line segments`. Use it when the visual form makes the user's question faster to answer than a table or a simpler chart would.
