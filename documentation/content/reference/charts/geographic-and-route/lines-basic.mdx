...
Lines is part of the **Geographic and route** chart family and is intended for `Line segments with from/to points and a value`. Use it when the visual form makes the user's question faster to answer than a table or a simpler chart would.
...
pub struct LinesChart;

impl From<LinesChart> for Widget {
    fn from(_: LinesChart) -> Widget {
        Chart::new()
            .title("Lines")
            .width(720.0)
            .height(480.0)
