...
Bubble scatter is part of the **Statistical and finance** chart family and is intended for `Vec<(x, y, size)>`. Use it when the visual form makes the user's question faster to answer than a table or a simpler chart would.
