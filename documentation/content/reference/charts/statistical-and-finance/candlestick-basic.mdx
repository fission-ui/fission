...
Candlestick is part of the **Statistical and finance** chart family and is intended for `Rows of open, close, low, high values`. Use it when the visual form makes the user's question faster to answer than a table or a simpler chart would.
...
impl From<CandlestickChart> for Widget {
    fn from(_: CandlestickChart) -> Widget {
        Chart::new()
            .title("Candlestick")
            .width(720.0)
            .height(480.0)
