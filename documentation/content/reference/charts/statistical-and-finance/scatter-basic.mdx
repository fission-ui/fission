...
Scatter is part of the **Statistical and finance** chart family and is intended for `Vec<(f32, f32)>`. Use it when the visual form makes the user's question faster to answer than a table or a simpler chart would.
...
impl From<ScatterChart> for Widget {
    fn from(_: ScatterChart) -> Widget {
        Chart::new()
            .title("Scatter")
            .width(720.0)
            .height(480.0)
