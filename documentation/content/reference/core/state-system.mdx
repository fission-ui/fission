...
Use this checklist when wiring `State system` into an app or shell implementation.
...
Read [State, handles, and providers](/docs/guides/state-handles-and-providers/) for the guided version of this reference. For async work and reducer-side effect emission, continue to [Commands, services, and jobs](/reference/core/commands-services-jobs/) and [Resources and capabilities](/reference/core/resources-and-capabilities/). For the component conversion boundary that reads from this state system, see [Widget authoring boundary](/reference/core/widget-authoring-boundary/).
