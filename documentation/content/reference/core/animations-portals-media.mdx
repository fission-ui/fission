...
For the component conversion contract, see [Widget authoring boundary](/reference/core/widget-trait/). For the guide-level explanation, read [Media, animation, portals, and 3D](/docs/guides/media-animation-portals-and-3d/). For concrete media widgets, see [Media and custom surfaces](/reference/widgets/media/).
