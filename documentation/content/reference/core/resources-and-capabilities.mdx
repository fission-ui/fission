...
For reducer-side jobs, services, and commands, continue to [Commands, services, and jobs](/reference/core/commands-services-jobs). For built-in device and host capability groups, see [Platform capabilities](/reference/core/platform-capabilities/). For the component conversion contract that declares resources, pair this page with [Widget authoring boundary](/reference/core/widget-authoring-boundary). For the broader async teaching guide, see [Resources and async](/docs/guides/resources-and-async).
