...
| File system | `effects.file_system()` | built-in shell operation provider | `AsyncRegistry` operation providers | [File system](/reference/capabilities/file-system/) |
...
| `filesystem` | none | none | Enables direct native paths and platform directory providers; picker-based hosts still require user selection. |
