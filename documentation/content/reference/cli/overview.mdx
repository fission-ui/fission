...
Packages an app or site into a release artifact manifest. Current relevant pairs include `static-site/static`, `static-site/docker-image`, `ssr/docker-image`, `linux/run`, `macos/app`, `macos/pkg`, `windows/exe`, `windows/msi`, `windows/msix`, `android/apk`, `android/aab`, and `ios/ipa`.
