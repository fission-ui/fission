...
| `painter` | `Arc<dyn Fn(&mut LoweringContext) -> Vec<WidgetId> + Send + Sync>` | Closure that emits child IR ids directly into the lowering context. | Required. This is the advanced part of the public contract. |
