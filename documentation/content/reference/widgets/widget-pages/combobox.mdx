...
| --- | --- | --- | --- |
| `id` | `WidgetId` | Stable identity for the combobox and its popover anchor. | Required. |
...
If a screen starts repeating the same `Combobox` setup, extract a named component around this widget. That keeps the reference API small while making product code easier to read and safer for generated code to copy.
