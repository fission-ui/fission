...
During component conversion, `TerminalView` tells the session to resize itself for the current viewport. That is how the terminal knows how many rows and columns should fit in the available space.
