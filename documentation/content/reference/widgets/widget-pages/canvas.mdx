...
| `painter` | `Fn(&mut LoweringContext) -> Vec<WidgetId>` | Closure that emits child IR ids to group inside the canvas box. | Required. This is an advanced lowering hook, not normal app authoring. |
