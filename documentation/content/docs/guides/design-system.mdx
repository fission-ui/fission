...
| --- | --- | --- |
| Fission default (Graphite) | `FissionDefaultDesignSystem` | You want Fission's own look: ink-black primary actions, zinc neutrals, one blue accent for focus, links and selection controls. |
