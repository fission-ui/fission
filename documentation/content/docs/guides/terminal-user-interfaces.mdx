...
description: Build terminal applications with the same Fission widget, reducer, and shell model used by desktop, web, mobile, static site, and server-rendered site targets.
---
