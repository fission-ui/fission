...
After this guide, you should be able to explain where `Workers and islands` fits in the Fission lifecycle, identify the file or component you changed, run the relevant `fission` command, and verify the result in a real target or test.
