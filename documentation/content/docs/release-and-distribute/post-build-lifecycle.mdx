...
The project can reference account IDs, bundle IDs, package names, certificate thumbprints, or environment variable names, but it should not contain credential material or repo-local secret file paths.
