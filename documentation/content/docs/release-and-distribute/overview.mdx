...
Use [Local publishing](/docs/release-and-distribute/local-publishing/) when a developer is proving the flow interactively on their machine. Use [CI publishing](/docs/release-and-distribute/ci-publishing/) when all choices and secrets are supplied non-interactively. In both cases, follow the [App release checklist](/docs/release-and-distribute/app-release-checklist/) before upload.
