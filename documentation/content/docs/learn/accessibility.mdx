...
| Android | AccessKit through the Android accessibility stack | Supported through the generated AndroidX GameActivity host. Validate with TalkBack, Switch Access, and Voice Access on the Android versions you ship. |
...
This is not a promise that every possible platform accessibility feature is complete. It is the current public contract. Advanced features such as custom rotor behavior and platform-specific landmarks beyond current roles need additional implementation.
