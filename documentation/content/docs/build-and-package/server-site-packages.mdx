---
title: Server site packages
description: Package Fission SSR targets as deployable Docker images.
---
...
fission readiness package --project-dir examples/pokemon-card-store --target ssr --format docker-image
```
...
Use [Docker registry publishing](/docs/release-and-distribute/docker-registries/) when the image is ready to push.
