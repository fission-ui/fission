---
title: Static site packages
description: Package Fission static sites as static artifacts or Docker images.
---
...
```bash
fission package --project-dir documentation --target static-site --format docker-image --release
```
...
Use [Static hosting](/docs/release-and-distribute/static-hosting/) to publish the generated site.
