...
fn on_audio_captured(state: &mut AppState, capture: MicrophoneCapture) {
...
fn on_audio_capture_failed(state: &mut AppState, error: MicrophoneError) {
    state.recording = false;
...
impl Widget<AppState> for RecordVoiceNoteButton {
