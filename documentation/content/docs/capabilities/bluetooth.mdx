...
fn on_bluetooth_devices_found(state: &mut AppState, result: BluetoothScanResult) {
...
fn on_bluetooth_scan_failed(state: &mut AppState, error: BluetoothError) {
    state.scanning_bluetooth = false;
...
impl Widget<AppState> for ScanBluetoothDevicesButton {
