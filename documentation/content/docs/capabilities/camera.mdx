...
fn on_photo_captured(state: &mut AppState, capture: CameraCapture) {
...
fn on_photo_capture_failed(state: &mut AppState, error: CameraError) {
    state.capturing = false;
...
impl Widget<AppState> for CaptureProfilePhotoButton {
