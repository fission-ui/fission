...
The current production slice covers the chart families most apps need first: line, bar, area, step line, pie, donut, scatter, boxplot, candlestick, heatmap, radar, funnel, gauge, treemap, sunburst, graph, sankey, theme river, parallel coordinates, choropleth maps backed by GeoJSON, pictorial bars, effect scatter, liquid fill, word cloud, dataset encoding, legends, visual maps, and the first data-zoom presentation work.
