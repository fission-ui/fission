...
const entries = [
  ...
  e('sunburst-basic', 'Sunburst', 'Relationships and hierarchy', 'sunburst', 'planned', 'A hierarchy drawn as concentric rings.', 'Nested nodes with values.', 'Use it when hierarchy depth should remain visible.', ['sunburst', 'hierarchy']),
  ...
  e('theme-river', 'Stream river', 'Relationships and hierarchy', 'theme-river', 'planned', 'Stacked flowing bands over time.', 'Time, value, and category tuples.', 'Use it when composition changes continuously over time.', ['stream', 'time']),
  ...
  e('map-choropleth', 'Choropleth map', 'Geographic and calendar', 'map', 'planned', 'Regions colored by a numeric value.', 'Region identifiers plus values and GeoJSON geometry.', 'Use it for geography-first comparison.', ['map', 'geo']),
