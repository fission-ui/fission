...
use fission::core::ui::{Button, ButtonVariant, Container, Row, Switch, Text, TextContent};
            ...
            let quick_actions = Menu {
                items: vec![
                    ...
                    MenuItem {
                        ...
                        on_select: Some(fission::core::ActionEnvelope {
                            id: toast_id,
                            payload: serde_json::to_vec(&ShowToast(t("toast.add_reminder")))
                                .unwrap(),
                        }),
                    },
                ],
