...
BUNDLE_ID="${IOS_BUNDLE_ID:-com.fission.examples.fieldinspector}"
DISPLAY_NAME="${IOS_DISPLAY_NAME:-FieldInspector}"
EXECUTABLE_NAME="${IOS_EXECUTABLE_NAME:-field_inspector}"
