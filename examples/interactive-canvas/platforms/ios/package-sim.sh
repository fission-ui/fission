...
BUNDLE_ID="${IOS_BUNDLE_ID:-dev.fission.interactive_canvas}"
DISPLAY_NAME="${IOS_DISPLAY_NAME:-InteractiveCanvas}"
EXECUTABLE_NAME="${IOS_EXECUTABLE_NAME:-interactive_canvas}"
