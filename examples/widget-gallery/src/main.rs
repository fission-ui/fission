...
impl BuildInline for Divider {
    fn build_inline(self) -> Node {
        Container::<Node>::lowered(fission::core::ui::widgets::Spacer::default().into_node())
            .height(1.0)
            .bg(IrColor {
                r: 200,
                g: 200,
        ...
        fission::core::view::internal_node_widget({
            {
                        ...
                        HStack {
                            ...
                            children: vec![
                                Button {
                                    ...
                                    on_press: Some(
                                        ctx.bind(Noop, reduce_with!((|_, _: Noop, _| {}))),
                                    ),
                                    ..Default::default()
                                }
                                .into_node(),
                            ...
                            children: vec![
                                ...
                                Switch {
                                    ...
                                    on_toggle: Some(ctx.bind(
                                        ToggleSwitch,
                                        reduce_with!(
                                            (|s: &mut GalleryState, _, _| s.switch_on =
                                                !s.switch_on)
                                        ),
                                    )),
                                    ..Default::default()
                                ...
                                Container::<fission::Node>::lowered(
                                    Slider {
                                        ...
                                        on_change: Some(ctx.bind(
                                            SetSlider(0.0),
                                            reduce_with!(
                                                (|s: &mut GalleryState, a: SetSlider, _| {
                                                    s.slider_val = a.0
                                                })
                                            ),
                                        )),
                ...
                let feedback_section = section(
                    ...
                    vec![
                        ...
                        HStack {
                            spacing: Some(16.0),
                            children: vec![ProgressBar { value: 0.65 }
                                .build(ctx, view)
                                .into_widget()
                                .lower_to_node(ctx, view)],
                        }
                            ...
                            items: vec![
                                TabItem {
                                    ...
                                    on_press: Some(ctx.bind(
                                        SetTab(0),
                                        reduce_with!(
                                            (|s: &mut GalleryState, a: SetTab, _| s.active_tab =
                                                a.0)
                                        ),
                                    )),
                                },
                        ...
                        SegmentedControl {
                            ...
                            on_change: Some(Arc::new({
                                let env = ctx.bind(
                                    SetSegmented(0),
                                    reduce_with!(
                                        (|s: &mut GalleryState, a: SetSegmented, _| s
                                            .segmented_idx =
                                            a.0)
                                    ),
                                );
                        ...
                        Pagination {
                            ...
                            on_change: Some(Arc::new({
                                let env = ctx.bind(
                                    SetPage(1),
                                    reduce_with!(
                                        (|s: &mut GalleryState, a: SetPage, _| s.current_page =
                                            a.0)
                                    ),
                                );
                            ...
                            children: vec![
                                Button {
                                    ...
                                    on_press: Some(ctx.bind(
                                        ToggleModal,
                                        reduce_with!(
                                            (|s: &mut GalleryState, _, _| s.modal_open =
                                                !s.modal_open)
                                        ),
                                    )),
                                    ..Default::default()
                                ...
                                Button {
                                    ...
                                    on_press: Some(ctx.bind(
                                        ToggleDrawer,
                                        reduce_with!(
                                            (|s: &mut GalleryState, _, _| s.drawer_open =
                                                !s.drawer_open)
                                        ),
                                    )),
                                    ..Default::default()
                ...
                Scroll {
                    ...
                    child: Some(Box::new(
                        Container::<fission::Node>::lowered(all_sections)
                            .padding_all(24.0)
                            .into_node(),
                    )),
                    show_scrollbar: true,
