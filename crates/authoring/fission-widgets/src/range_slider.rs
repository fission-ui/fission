    ...
    fn lower_dyn(&self, cx: &mut LoweringContext) -> NodeId {
        ...
        let mut grid = NodeBuilder::new(
            ...
            Op::Layout(LayoutOp::Grid {
                ...
                column_gap: None, row_gap: None, padding: [0.0; 4]
            })
        );
        
        // Thumb 1
        let thumb1 = NodeBuilder::new(cx.next_node_id(), Op::Paint(PaintOp::DrawRect {
            fill: Some(Fill { color: tokens.colors.primary }),
            stroke: None,
            corner_radius: thumb_size/2.0,
            shadow: None,
        })).build(cx);
        let mut item1 = NodeBuilder::new(cx.next_node_id(), Op::Layout(LayoutOp::GridItem {
            row_start: fission_ir::op::GridPlacement::Line(1), row_end: fission_ir::op::GridPlacement::Auto,
            col_start: fission_ir::op::GridPlacement::Line(2), col_end: fission_ir::op::GridPlacement::Auto,
        }));
        let mut box1 = NodeBuilder::new(cx.next_node_id(), Op::Layout(LayoutOp::Box { width: Some(thumb_size), height: Some(thumb_size), min_width: None, max_width: None, min_height: None, max_height: None, padding: [0.0;4], flex_grow: 0.0, flex_shrink: 0.0, aspect_ratio: None }));
        box1.add_child(thumb1);
        item1.add_child(box1.build(cx));
        grid.add_child(item1.build(cx));

        // Thumb 2
        let thumb2 = NodeBuilder::new(cx.next_node_id(), Op::Paint(PaintOp::DrawRect {
            fill: Some(Fill { color: tokens.colors.primary }),
            stroke: None,
            corner_radius: thumb_size/2.0,
            shadow: None,
        })).build(cx);
        let mut item2 = NodeBuilder::new(cx.next_node_id(), Op::Layout(LayoutOp::GridItem {
            row_start: fission_ir::op::GridPlacement::Line(1), row_end: fission_ir::op::GridPlacement::Auto,
            col_start: fission_ir::op::GridPlacement::Line(4), col_end: fission_ir::op::GridPlacement::Auto,
        }));
        let mut box2 = NodeBuilder::new(cx.next_node_id(), Op::Layout(LayoutOp::Box { width: Some(thumb_size), height: Some(thumb_size), min_width: None, max_width: None, min_height: None, max_height: None, padding: [0.0;4], flex_grow: 0.0, flex_shrink: 0.0, aspect_ratio: None }));
