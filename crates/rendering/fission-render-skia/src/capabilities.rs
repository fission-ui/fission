...
///
/// The profile presents directly to a host-owned Linux/Android Vulkan, Apple
/// Metal, or Windows D3D12 native window. It does not advertise headless
/// rendering, external surfaces, or 3D interop. The shared color-format set is
/// the union of the required BGRA presentation format and the RGBA readback
/// format; attaching a Ganesh target still requires `Bgra8Srgb`.
