...
use crate::components::{ActionButton, ButtonTone, FormTextField, KeyValueRow, TogglePill};
...
impl From<SiteScreen> for Widget {
    fn from(_component: SiteScreen) -> Self {
        ...
        Column {
            ...
            children: vec![
                ...
                Row {
                    gap: Some(1.0),
                    children: vec![
                        TogglePill::new("Release", view.state().release, release).into(),
                        TogglePill::new("No open", view.state().no_open, no_open).into(),
                    ],
                    ..Default::default()
                }
                .into(),
