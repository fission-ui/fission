...
impl UiDensity {
    ...
    pub(crate) fn shell_gap(self) -> f32 {
        if self.compact {
            0.0
        } else {
            1.0
    ...
    pub(crate) fn outer_padding(self) -> [f32; 4] {
        if self.compact {
            [1.0, 1.0, 0.0, 0.0]
        } else {
            [2.0, 2.0, 1.0, 1.0]
    ...
    pub(crate) fn content_padding(self) -> [f32; 4] {
        if self.compact {
            [1.0, 1.0, 0.0, 0.0]
        } else {
            [2.0, 2.0, 1.0, 1.0]
    ...
    pub(crate) fn sidebar_padding(self) -> [f32; 4] {
        if self.compact {
            [1.0, 1.0, 0.0, 0.0]
        } else {
            [1.0, 1.0, 1.0, 1.0]
    ...
    pub(crate) fn nav_route_height(self) -> f32 {
        if self.compact {
            1.0
        } else {
            4.0
    ...
    pub(crate) fn control_padding(self) -> [f32; 4] {
        if self.compact {
            [0.0, 0.0, 0.0, 0.0]
        } else {
            [1.0, 1.0, 0.0, 0.0]
    ...
    pub(crate) fn text_input_height(self) -> f32 {
        if self.compact {
            3.0
        } else {
            5.0
    ...
    pub(crate) fn text_input_padding(self) -> [f32; 4] {
        if self.compact {
            [0.0, 0.0, 0.0, 0.0]
        } else {
            [1.0, 1.0, 0.0, 0.0]
    ...
    pub(crate) fn output_log_height(self, panel_height: f32) -> f32 {
        let reserved = if self.compact { 2.0 } else { 3.0 };
        (panel_height - reserved).max(1.0)
    }

    pub(crate) fn shell_metrics(self, height: f32) -> ShellMetrics {
